//Local Storage for Number of site visits

let numVisits = document.querySelector('#pageVisits');
...
if (numOfVisits != 0) {
    ...
    numVisits.textContent = 'It has been ' + numOfDays + ' day(s) since your last visit.'
